...
The project aims to create a simple and convenient tool for converting scripts written in Python, in a sequence of shell commands bash.
...
# Refferences.
* Article, where simple examples described the use of the module ast for the analysis of Python code:
